                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        ...
                        <ul class="nav nav-icons">
                            <li class="active"><a href="admin/#"><i class="icon-envelope"></i></a></li>
                            <li><a href="admin/#"><i class="icon-eye-open"></i></a></li>
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Dropdown
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="admin/#">Item No. 1</a></li>
                                    <li><a href="admin/#">Don't Click</a></li>
                                    <li class="divider"></li>
                                    <li class="nav-header">Example Header</li>
                                    <li><a href="admin/#">A Separated link</a></li>
                                </ul>
                            </li>
